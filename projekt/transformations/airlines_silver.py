...
def main():
    ...
    spark = SparkSession.builder.appName("airlines_silver").getOrCreate()
    ...
    AIRLINES_SCHEMA = StructType([
        ...
        StructField("date_founded", StringType(), True),
        StructField("fleet_average_age", StringType(), True),
        StructField("fleet_size", StringType(), True),
        StructField("hub_code", StringType(), True),
        StructField("iata_code", StringType(), True),
        StructField("iata_prefix_accounting", StringType(), True),
    ...
    for file_path in file_paths:
        ...
        df = spark.createDataFrame(raw_json.select('data').collect()[0][0], schema=AIRLINES_SCHEMA)
    ...
    delete_files_with_prefix("/user/projekt/bronze/stage/samoloty", "airline")
